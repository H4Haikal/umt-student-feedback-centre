<%-- 
    ...
    Created on : 1 Jun 2025, 11:17:58 am
    Author     : User
--%>
...
<html lang="en">
    ...
    <body id="top">
        <main>
            <% request.setAttribute("currentPage", "studentDash");%>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card shadow-sm p-4 position-relative">
                                ...
                                <p class="lead">This is your personal dashboard where you can track your progress and manage your account.</p>
                                ...
                                <div class="d-flex gap-3">
                                    ...
                                    <a href="feedback?action=list" class="btn btn-outline-info btn-lg">
